<!--This page will display the content for learning of concatenation -->
<!DOCTYPE html>
<?php
//connect to database
...
<div class="main">
 ...
 //get content from database
			try {
				...
				$stmt = $db->query('SELECT postTitle, postCont  FROM concatenation WHERE editedBy = "admin" ');
...
<script>
 ...
 //get code example from database
			try {
				...
				$stmt = $db->query('SELECT codeExample  FROM concatenation WHERE editedBy = "admin" ');
				while($row = $stmt->fetch()){
