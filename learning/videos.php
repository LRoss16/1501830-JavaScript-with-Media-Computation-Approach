<!--This page will display the content for the videos example -->
<!DOCTYPE html>
<?php
//connect to database
...
<div class="sidenav">
  ...
  <a href="videos.php"><current-page>Videos</current-page></a>
</div>
...
<div class="main">
 ...
 //get content from database
			try {
				...
				$stmt = $db->query('SELECT postTitle, postCont  FROM video WHERE editedBy = "admin"');
...
<p>Click <a href="../examples/videos.php" target="_blank">here</a> to try out the example </p>
</div>
