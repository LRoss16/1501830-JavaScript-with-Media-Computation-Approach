<?php
//This page is the homepage for logged in students
...
//if do not have access, redirect
...
<h3>Your teacher is <?php echo $_SESSION['teacher'] ?></h3>
...
//get the content set by students teacher
			...
			$state = $db->prepare('SELECT postTitle, postCont FROM about WHERE editedBy= :teacher') ;
