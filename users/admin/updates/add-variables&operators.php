	...
	if(isset($_POST['submit'])){
		...
		if(!isset($error)){
			...
			try {
				...
				$stmt = $db->prepare('INSERT INTO variablesOperators (postTitle,postCont,postDate,editedBy) VALUES (:postTitle, :postCont, :postDate, :editedBy)') ;
				...
				header('Location: variables&operators.php?action=added');
