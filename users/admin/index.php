...
<div id="about">
<h1>About</h1>
<p>For the past number of years Media Computation has been a useful way to teach students how to code using the languages Python and Java </p>
<p>The aim of this website is to use these methods but for JavaScript. This is an extremely popular language so is a very important one to learn.</p>
</div>
</div>
