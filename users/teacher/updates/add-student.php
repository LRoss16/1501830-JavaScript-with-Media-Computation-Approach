...
<div id="wrapper">
	...
	//make sure a valid teacher is set for student
			if( $query->rowCount() > 0 ) { # If rows are found for query
 ...
 $mail = new PHPMailer(TRUE);
  ...
  // $mail->send();
	...
	<form action='' method='post'>
		...
		<input type='teacher' readonly name='teacher' value='<?php echo $username;?>'></p>		
