...
<div id="wrapper">
	...
	if(isset($_POST['submit'])){
		...
		if(!isset($error)){
			...
			try {
				...
				$stmt = $db->prepare('UPDATE strings SET postDate = :postDate, codeExample=:codeExample WHERE postID = :postID') ;
	...
	if(isset($error)){
		...
		try {
			...
			$stmt = $db->prepare('SELECT postID, codeExample FROM strings WHERE postID = :postID') ;
